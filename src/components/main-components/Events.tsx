  ...
  return (
    <section ref={sectionRef} className="min-h-screen bg-[#F8CFCF] py-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Movies Section - Mobile Horizontal Layout */}
        <div
        ...
        >
          <div className="group bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl rounded-2xl p-4 shadow-2xl border border-white/30 hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {/* Mobile Layout - Horizontal Stats + Movies */}
              <div className="block md:flex gap-6">
                {/* Event Stats - Horizontal on Mobile */}
                <div className="w-full md:w-48 mb-6  md:mb-0">
                  <div className="flex md:flex-col gap-4 overflow-x-auto md:overflow-visible scrollbar-hide pb-2 md:pb-0">
                    <div className="text-center flex-shrink-0 w-20 md:w-auto">
                      <div className="relative mb-1 md:mb-2">
                        <span className="text-lg md:text-2xl font-black bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                          500+
                        </span>
                        <div className="absolute -top-1 -right-1 w-1.5 md:w-2 h-1.5 md:h-2 bg-blue-500 rounded-full animate-ping opacity-75"></div>
                      </div>
                    ...
                    <div className="text-center flex-shrink-0 w-20 md:w-auto">
                      <div className="relative mb-1 md:mb-2">
                        <span className="text-lg md:text-2xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
                          50+
                        </span>
                        <div className="absolute -top-1 -right-1 w-1.5 md:w-2 h-1.5 md:h-2 bg-green-500 rounded-full animate-ping opacity-75"></div>
                      </div>
                    ...
                    <div className="text-center flex-shrink-0 w-20 md:w-auto">
                      <div className="relative mb-1 md:mb-2">
                        <span className="text-lg md:text-2xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                          1M+
                        </span>
                        <div className="absolute -top-1 -right-1 w-1.5 md:w-2 h-1.5 md:h-2 bg-purple-500 rounded-full animate-ping opacity-75"></div>
                      </div>
                    ...
                    <div className="text-center flex-shrink-0 w-20 md:w-auto">
                      <div className="relative mb-1 md:mb-2">
                        <span className="text-lg md:text-2xl font-black bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
                          98%
                        </span>
                        <div className="absolute -top-1 -right-1 w-1.5 md:w-2 h-1.5 md:h-2 bg-orange-500 rounded-full animate-ping opacity-75"></div>
                      </div>
                ...
                <div className="flex-1">
                  <div className="grid grid-cols-4 gap-3 md:gap-6">
                    {movies.map((movie, index) => (
                      ...
                      >
                        <div className="aspect-[3/4] max-h-[180px] md:max-h-[260px] rounded-xl shadow-lg group-hover/movie:shadow-xl transition-all duration-500 group-hover/movie:scale-105 relative overflow-hidden bg-gradient-to-t from-black/20 to-transparent">
                          <Image
                            src={movie.poster}
                            alt={movie.name}
                            fill
                          ...
                          <div className="absolute bottom-1 md:bottom-2 left-1 md:left-2 right-1 md:right-2 text-white opacity-0 group-hover/movie:opacity-100 transition-opacity duration-300">
                            <p className="font-bold text-xs leading-tight">{movie.name}</p>
                            {movie.subtitle && (
                              <p className="text-white/80 text-[8px] md:text-[10px] mt-0.5">
                                {movie.subtitle}
                              </p>
                            )}
                          </div>
        ...
        {/* Events Section - Smaller Cards on Mobile + Touch Swipe */}
        <div className={`mb-16 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="group bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl rounded-3xl p-4 md:p-6 shadow-2xl border border-white/30 hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative z-10">
              <div className="text-center mb-6 md:mb-8">
                <div className="flex items-center justify-center gap-3 md:gap-4 mb-3 md:mb-4">
                  <div className="w-1.5 md:w-2 h-6 md:h-8 bg-gradient-to-b from-blue-500 to-cyan-600 rounded-full shadow-lg"></div>
                  <h3 className="text-2xl md:text-3xl font-black text-slate-800 tracking-tight">500+ Epic Events</h3>
                  <div className="w-1.5 md:w-2 h-6 md:h-8 bg-gradient-to-b from-blue-500 to-cyan-600 rounded-full shadow-lg"></div>
                </div>
                <p className="text-slate-600 font-medium text-sm md:text-base">Unforgettable experiences, delivered flawlessly</p>
              </div>

              <div
                ref={eventsScrollRef}
                className="flex gap-4 md:gap-6 overflow-x-auto md:overflow-x-hidden scrollbar-hide touch-pan-x"
              ...
              >
                {[...events, ...events].map((event, index) => (
                  ...
                  >
                    <div className="aspect-video h-32 md:h-auto rounded-xl md:rounded-2xl shadow-lg group-hover/event:shadow-xl transition-all duration-500 group-hover/event:scale-110 relative overflow-hidden">
                      <Image
                        src={event.image}
                        alt={event.title}
                        fill
                      ...
                      <div className="absolute bottom-2 md:bottom-3 left-2 md:left-3 right-2 md:right-3 text-white opacity-0 group-hover/event:opacity-100 transition-opacity duration-300">
                        <p className="font-bold text-sm md:text-base">{event.title}</p>
                      </div>
                    </div>
                    <p className="text-center mt-2 md:mt-3 text-sm md:text-base font-bold text-slate-800 group-hover/event:hidden transition-opacity duration-300">{event.title}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* Influencers Section - Compact Mobile Layout */}
        <div className={`transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="group bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl rounded-3xl p-4 md:p-6 shadow-2xl border border-white/30 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-6 md:mb-8">
                <div className="flex items-center justify-center gap-3 md:gap-4 mb-2 md:mb-3">
                  <div className="w-1.5 md:w-2 h-5 md:h-6 bg-gradient-to-b from-pink-500 to-purple-600 rounded-full shadow-lg"></div>
                  <h3 className="text-xl md:text-2xl font-black text-slate-800 tracking-tight">Star Influencers</h3>
                  <div className="w-1.5 md:w-2 h-5 md:h-6 bg-gradient-to-b from-pink-500 to-purple-600 rounded-full shadow-lg"></div>
                </div>
                <h4 className="text-base md:text-lg font-bold text-slate-700 mb-2">People Who Put Their Name Behind Ours</h4>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                {influencers.map((influencer, index) => (
                  ...
                  >
                    <div className="bg-gradient-to-br from-white/80 to-white/60 rounded-lg md:rounded-xl p-3 md:p-4 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-white/40 group-hover/influencer:border-purple-200 relative overflow-hidden">
                      ...
                      <div className="relative z-10 flex flex-col items-center text-center">
                        <div className="relative w-12 md:w-16 h-12 md:h-16 mb-2 md:mb-3 rounded-full shadow-lg group-hover/influencer:scale-110 transition-transform duration-500 ring-2 md:ring-3 ring-white/50 group-hover/influencer:ring-purple-200">
                          <Image
                          ...
                          />
                          {influencer.verified && (
                            <div className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 w-4 md:w-5 h-4 md:h-5 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center shadow-xl ring-1 md:ring-2 ring-white animate-pulse">
                        ...
                        <h5 className="font-black text-xs md:text-sm text-slate-800 mb-1">{influencer.name}</h5>
                        <p className="text-slate-600 text-[10px] md:text-xs mb-1 font-medium">{influencer.username}</p>
                        <p className="text-slate-500 text-[10px] md:text-xs mb-2 font-medium">{influencer.category}</p>

                        <div className="flex items-center gap-1 md:gap-2 px-2 py-1 bg-gradient-to-r from-slate-100 to-slate-50 rounded-full border border-slate-200 group-hover/influencer:from-purple-50 group-hover/influencer:to-pink-50 group-hover/influencer:border-purple-200 transition-all duration-300">
                          <div className="w-1 md:w-1.5 h-1 md:h-1.5 bg-gradient-to-r from-green-400 to-green-500 rounded-full animate-pulse"></div>
                          <span className="text-slate-700 text-[10px] md:text-xs font-bold">{influencer.followers} followers</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-6 md:mt-8 flex justify-center">
                <div className="w-24 md:w-32 h-1 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 rounded-full shadow-lg animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
